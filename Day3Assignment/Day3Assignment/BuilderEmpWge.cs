...
internal class BuilderEmpWge
{
    ...
    public BuilderEmpWge(string company, int empRatePerHour, int numOfWorkingDays, int maxHoursPerMonth) // constructor is used to assign values
    {
